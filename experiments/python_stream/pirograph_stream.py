...
def process_frame(frame):
    ...
    frame_y = np.array(frame_rgb_image.convert("YCbCr"))[0:height, 0:width, 0]
    ...
    # print("frame_rgb_image: ", frame_rgb_image.size, frame_rgb_image.mode)
    # print("composite: ", composite.size, composite.mode)
